// show all members from the base package
...
/// Initiali
void initLiteRTFlutter(){

  // load base tflite runtime
  if(InstalledLibs().libsInstalled){
    print("Libs are really installed");
  }
  else {
    throw Exception("lite_rt_for_flutter_libs package is not installed");
  }

}

/// Adds flutter erlated utilities to the base interpreter class
